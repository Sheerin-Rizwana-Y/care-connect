...
export default function MessagesPage() {
  ...
  useEffect(() => {
    if (activeConv) fetchMessages(activeConv.other_user_id);
  }, [activeConv]);
          ...
          <>
            ...
            <div className="p-4 border-b border-gray-100 flex items-center gap-3">
              ...
              <div className="ml-auto">
                <button onClick={() => toast.success('Report submitted')}
                  className="text-gray-400 hover:text-red-500 transition-colors p-1" title="Report conversation">
